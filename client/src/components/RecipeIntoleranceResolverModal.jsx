...
import { X, Sparkles, RefreshCw, AlertCircle, ArrowRight, Check, Flag } from 'lucide-react';
                                ...
                                return (
                                    <div key={pid} className="space-y-4">
                                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                                            <div className="flex-1 p-4 rounded-2xl bg-destructive/5 border border-destructive/20 relative group">
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                                        setReportContext({
                                                            ...
                                                            additionalContext: `IntoleranceResolver: ${recipe.title}`
                                                        });
                                                        setIsReportModalOpen(true);
                                                    }}
                                                    className="absolute top-2 right-2 text-destructive/40 hover:text-orange-500 p-1 rounded-lg transition-colors opacity-0 group-hover:opacity-100"
                                                    title="Fehler melden"
                                                >
                                                    <Flag size={14} />
                                                </button>
