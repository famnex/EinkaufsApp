...
export default function HelpTab({ user, setUser, api }) {
    ...
    const helpTopics = [
        {
            id: '1',
            trigger: '🏠 1. Die Listenansicht',
            content: (
                <div className="space-y-4 text-sm text-foreground leading-relaxed">
                    <p>Die Kalenderansicht bietet dir einen perfekten Überblick über deine geplanten Einkaufslisten.</p>
                    ...
                    <p><strong>Listen erstellen und löschen:</strong> Tippe auf einen leeren Tag im "Erstellen"-Modus, um eine neue Liste zu erstellen, oder tippe auf eine Liste im "Löschen"-Modus der App, um sie zu entfernen.</p>
                </div>
            )
        },
        {
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4 text-sm text-foreground leading-relaxed">
                    ...
                    <p><strong>Aktionsmenü:</strong> Klicke auf die drei Punkte an einer Rezeptkachel. Hier kannst du das Rezept bearbeiten, einplanen, auf Einkaufslisten legen, drucken, löschen oder mit Freunden teilen.</p>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4 text-sm text-foreground leading-relaxed">
                    ...
                    <p><strong>KI-Ersatzprodukte (Double-Tap):</strong> Tippe zweimal schnell hintereinander (Double-Tap) auf eine Zutat. Die KI sucht dir sofort passende Alternativen heraus, prüft diese auf Unverträglichkeiten in deinem Haushalt und tauscht das Produkt auf Knopfdruck aus.</p>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4 text-sm text-foreground leading-relaxed">
                    ...
                    <p><strong>App-Nutzung & Fokus:</strong> Auch bei "Präferenzen" kannst du deine am Anfang hinterlegten EInstellungen zur Appnutzung anpassen. Aktiviere und Deaktiviere hier funktionen der App, wie z.B. Die Einkaufslisten, den Menüplan oder das Rezeptbuch.</p>
