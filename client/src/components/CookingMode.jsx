            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-4 pb-2">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="flex items-center gap-1 bg-muted/50 rounded-lg p-1 mr-1">
                ...
                <div className="flex-1 relative flex flex-col md:flex-row overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 z-50 hidden md:flex gap-2">
                        {/* Text Size Controls for all screen sizes */}
                        <div className="flex items-center gap-1 bg-card/80 backdrop-blur-md border border-border rounded-full p-1 shadow-lg mr-2">
                            <Button
                                variant="ghost"
                                size="icon"
                            ...
                            <span className="text-sm font-black w-8 text-center px-1">Aa</span>
                            <Button
                                variant="ghost"
                                size="icon"
