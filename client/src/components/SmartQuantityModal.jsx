...
import { X, Check, ShoppingCart, AlertCircle, HelpCircle, Flag } from 'lucide-react';
                                                ...
                                                <button
                                                    ...
                                                    onClick={(e) => {
                                                        ...
                                                        setReportContext({
                                                            ...
                                                            additionalContext: `SmartQuantityModal: ${recipe.title}`
                                                        });
                                                        setIsReportModalOpen(true);
                                                    }}
                                                    className="text-muted-foreground/40 hover:text-orange-500 transition-colors p-1"
                                                    title="Fehler melden"
                                                >
                                                    <Flag size={12} />
                                                </button>
