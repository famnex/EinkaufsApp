...
export default function SlotMachineModal({ isOpen, onClose, recipes, onSelect, confirmLabel = "REZEPT EINPLANEN", ActionIcon = Calendar, disableIngredients = false, availableProducts = null }) {
    ...
    }, [isOpen, disableIngredients, availableProducts]);
                                ...
                                {!disableIngredients && (
                                    <>
                                        ...
                                        <div className="space-y-1.5 relative">
                                            <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Muss enthalten sein</label>
                                        ...
                                        <div className="space-y-1.5 relative">
                                            <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Darf nicht enthalten sein</label>
                                            <div className="min-h-[2.75rem] p-1.5 bg-muted/50 border border-border rounded-2xl flex flex-wrap gap-1.5 items-center">
